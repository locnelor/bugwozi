...
import * as requestModuleInterface from "./request.module.interface";
...
export class RequestService {
  constructor(
    @Inject(REQUEST_MODULE_OPTIONS_TOKEN)
    private options: requestModuleInterface.RequestModuleOptions,
  ) {}
