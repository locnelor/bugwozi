...
var StudySeatEntity = function () {
    ...
    var StudySeatEntity = _classThis = /** @class */ (function (_super) {
        __extends(StudySeatEntity_1, _super);
        function StudySeatEntity_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.seatNumber = __runInitializers(_this, _seatNumber_initializers, void 0);
            _this.roomId = (__runInitializers(_this, _seatNumber_extraInitializers), __runInitializers(_this, _roomId_initializers, void 0));
            _this.status = (__runInitializers(_this, _roomId_extraInitializers), __runInitializers(_this, _status_initializers, void 0));
            _this.reservations = (__runInitializers(_this, _status_extraInitializers), __runInitializers(_this, _reservations_initializers, void 0));
            __runInitializers(_this, _reservations_extraInitializers);
            return _this;
        }
        return StudySeatEntity_1;
    }(_classSuper));
    __setFunctionName(_classThis, "StudySeatEntity");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _seatNumber_decorators = [(0, graphql_1.Field)()];
        _roomId_decorators = [(0, graphql_1.Field)()];
        _status_decorators = [(0, graphql_1.Field)(function () { return Boolean; })];
        _reservations_decorators = [(0, graphql_1.Field)(function () { return [study_reservation_1.StudyReservationEntity]; }, { nullable: true })];
        ...
        StudySeatEntity = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return StudySeatEntity = _classThis;
}();
exports.StudySeatEntity = StudySeatEntity;
