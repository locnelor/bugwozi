...
var BlogTagEntity = function () {
    ...
    var BlogTagEntity = _classThis = /** @class */ (function (_super) {
        __extends(BlogTagEntity_1, _super);
        function BlogTagEntity_1() {
        ...
        return BlogTagEntity_1;
    }(_classSuper));
    __setFunctionName(_classThis, "BlogTagEntity");
    (function () {
        var _a;
        ...
        BlogTagEntity = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return BlogTagEntity = _classThis;
}();
